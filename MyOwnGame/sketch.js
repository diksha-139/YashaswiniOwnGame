...
function preload(){
  ...
  obstacle1 = loadAnimation("ob1.png");
  obstacle2 = loadAnimation("ob2.png");
  obstacle3 = loadAnimation("ob3.png");
  obstacle4 = loadAnimation("ob4.png");


  restartImg = loadImage("reset.png");
  
  endImage=loadAnimation("end.png");
...
function spawnRewards() {
  ...
  if (frameCount % 160 === 0) {
    ...
    var rand = Math.round(random(1,2));
    switch(rand) {
      case 1: reward.addImage(milkImg);
      reward.scale = 0.5;
              break;
      case 2: reward.addImage(fruitImg)
      reward.scale= 0.93
              break;
